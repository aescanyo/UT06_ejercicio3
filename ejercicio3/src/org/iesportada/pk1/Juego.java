...
* adivinar un número que conoce el programa. El código correspondiente a cada 
* clase que se implemente deberá estar en un fichero java separado y que 
* tenga el mismo nombre que la clase.
...
Tiene un constructor que toma dos parámetros de tipo entero. 
* El primero es el número de vidas que, a su vez, se lo pasará al 
* constructor de la clase base. El segundo parámetro es un número a adivinar entre 0 y 10.
Implementa el método Juega de la clase base:
    ◦ Llama al método ReiniciaPartida que ha heredado.

    ◦ Muestra un mensaje al usuario pidiendo que adivine un número entre el 1 y el 100.
    ...
    ◦ Lee un entero del teclado y lo compara con el valor predefinido por el programador:
         ...
         * vidas al jugador por lo que se muestra un mensaje indicando si el número
         * a adivinar es mayor o menor y se le pide que lo intente de nuevo.

         - Si el método QuitaVida devuelve false significa que ya no le quedan 
